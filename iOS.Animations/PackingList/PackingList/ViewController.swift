...
class ViewController: UIViewController {
    ...
    @IBAction func actionToggleMenu(_ sender: AnyObject) {
        ...
        titleLabel.superview?.constraints.forEach({ constraint in
            ...
            if constraint.identifier == "TitleCenterY" {
                ...
                let newConstraint = NSLayoutConstraint(item: titleLabel, attribute: .centerY, relatedBy: .equal, toItem: titleLabel.superview!, attribute: .centerY, multiplier: isMenuOpen ? 0.67 : 1, constant: 0)
        ...
        titleLabel.text = isMenuOpen ? "Selcet Item" : "Packing List"
    ...
    func showItem(_ index: Int) {
        ...
        UIView.animate(withDuration: 0.8, delay: 1.0, usingSpringWithDamping: 0.4, initialSpringVelocity: 0, options: []) {
